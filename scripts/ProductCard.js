...
const products = [
 ...
 new ProductCard("Lipstick", 25, "img/lipstic.png"), new ProductCard("Serum", 21, "https://img.joomcdn.net/b1970bab3307267165e2ac570f43d0d25b9a4d09_original.jpeg"), 
 new ProductCard("Cleanser foam", 40, "https://basket-15.wbbasket.ru/vol2200/part220005/220005288/images/big/1.webp"), 
 new ProductCard("Palette", 42, "img/palitr.png"), new ProductCard("Skin1004 Serum", 43, "https://ir.ozone.ru/s3/multimedia-l/6653411373.jpg"), 
 new ProductCard("Lash", 57 , "img/lash.png"), new ProductCard("Cleanser Foam", 25 , "https://a.lmcdn.ru/product/M/P/MP002XW13FNP_25478400_1_v2_2x.jpg"), 
...
document.addEventListener("click", function (e) {
  if (e.target.classList.contains("btn-cart")) {
    ...
    const price = card.querySelector(".product-price").textContent.replace("Price: $", "").trim();
